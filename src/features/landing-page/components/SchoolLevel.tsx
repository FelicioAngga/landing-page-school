  ...
  return (
    <div className="mt-16 flex flex-col gap-24">
      <div className="flex gap-10 justify-between">
        <div>
          <p className="text-3xl font-bold">Playgroup</p>
          <p className="mt-4 2xl:mt-6 text-[#637587] text-justify 2xl:text-xl max-w-[80vw]">
      ...
      <div className="flex gap-10 justify-between">
        ...
        />
        <div>
          <p className="text-3xl font-bold">Taman Kanak-kanak (TK)</p>
          <p className="mt-4 2xl:mt-6 text-[#637587] text-justify 2xl:text-xl max-w-[80vw]">
      ...
      <div className="flex gap-10 justify-between">
        <div>
          <p className="text-3xl font-bold">Sekolah Dasar (SD)</p>
          <p className="mt-4 2xl:mt-6 text-[#637587] text-justify 2xl:text-xl max-w-[80vw]">
      ...
      <div className="flex gap-10 justify-between">
        ...
        />
        <div>
          <p className="text-3xl font-bold">Sekolah Menengah Pertama (SMP)</p>
          <p className="mt-4 2xl:mt-6 text-[#637587] text-justify 2xl:text-xl max-w-[80vw]">
      ...
      <div className="flex gap-10 justify-between">
        <div>
          <p className="text-3xl font-bold">Sekolah Menengah Akhir (SMA)</p>
          <p className="mt-4 2xl:mt-6 text-[#637587] text-justify 2xl:text-xl max-w-[80vw]">
